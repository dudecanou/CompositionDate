package com.sircus.CompositionDate;

public class Date {
	private int  jour;  //un nombre de 1-31
	private int mois;  // un nombre de 1-12
	private int annee; // une année valable	
	...
	public int testJour(int unJour)
		    {
		        if (mois ==-1) return -1; // la date est déjà invalide, rien ne sert de poursuivre
		        ...
		        if (mois==2 && unJour==29 && ( annee%400 ==0 || ( annee %4==0 && annee %100 !=0)))
		             return unJour;
		        System.out.println("Le jour avec le mois entré précédemment n'est pas valide");
		         return -1;
	...
	public Date(int jour, int mois, int annee)
	   {
		   ...
		   // System.out.printf(" La date %s vient d'être construite \n", this);
	  } 
